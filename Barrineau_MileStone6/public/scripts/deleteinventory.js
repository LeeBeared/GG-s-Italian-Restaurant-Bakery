...
var Searchform = React.createClass({
    ...
    handle_submit: function (e) {
        ...
        var inventName = this.props.inventNamef.trim();
        var inventPrice = this.props.inventQuantityf.trim();
        var inventQuantity = this.props.inventPricef.trim();
        var error_string = "";
